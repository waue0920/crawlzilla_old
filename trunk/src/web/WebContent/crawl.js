...
function embed_code(num){
	...
	alert('<img src="http://' +serverIP+':8080/crawlzilla/' + 'img/logo.png" >'+'<form name="search" action="http://' +serverIP+ ':8080/' +fileName+ '/search.jsp" method="get"><input name="query" size=15></form>');
}
